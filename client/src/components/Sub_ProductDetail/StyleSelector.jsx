  ...
  return (
    <div className="style-selector">
      <div className="price" style={{ padding: '1rem 0' }}>
        {sale_price
          ? <p><span className="sale-price">${sale_price}</span> <span className="original-sale-price">${original_price}</span></p>
          : <p><span className="original-price">${original_price}</span></p>}
      </div>
